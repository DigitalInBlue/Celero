...
Finally, for good measure, we will simply use the Standard Library's sorting algorithm: _Introsort_. We only need write a single line of code, but here it is for completeness.
